...
diabetes = pickle.load(open('saved_model/diabetes_model.sav', 'rb'))
heart = pickle.load(open('saved_model/heart_disease_model.sav', 'rb'))
parkinson = pickle.load(open('saved_model/parkinsons_model.sav', 'rb'))
...
if selected == 'Diabetes Prediction':
    ...
    if st.button('Diabetes Test Result'):
        diabetic_prediction = diabetes.predict(
    ...
    if st.button("Parkinson's Test Result"):
        parkinson_prediction = parkinson.predict([[fo, fhi, flo, Jitter_percent, Jitter_Abs, RAP, PPQ, DDP,
